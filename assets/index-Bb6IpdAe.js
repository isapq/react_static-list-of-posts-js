...
aut aut aut maxime quia temporibus ut omnis`}],Nc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Pc=({user:e})=>j.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name}),Lc=({comment:e})=>j.jsxs("li",{className:"CommentInfo",children:[j.jsx("p",{className:"CommentInfo__name",children:e.name}),j.jsx("strong",{children:e.email}),": ",e.body]}),Tc=({comments:e})=>j.jsx("ul",{className:"CommentList",children:e.map(t=>j.jsx(Lc,{comment:t},t.id))}),Mc=({info:e})=>e?j.jsxs("div",{className:"PostInfo",children:[j.jsxs("div",{className:"PostInfo__header",children:[j.jsx("h3",{className:"PostInfo__title",children:e.title}),j.jsxs("p",{children:[" Posted by ",j.jsx("span",{className:"UserInfo",children:j.jsx(Pc,{user:e.user})})]})]}),j.jsx("p",{className:"PostInfo__body",children:e.body}),j.jsxs("div",{className:"PostInfo__comments",children:[j.jsx("h4",{children:"Comments:"}),e.comments&&e.comments.length>0?j.jsx(Tc,{comments:e.comments}):j.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments for this post"})]})]}):j.jsx("p",{children:"No post information available"}),Rc=({posts:e})=>j.jsx("div",{className:"PostList",children:e.map(t=>j.jsx(Mc,{info:t},t.id))}),Dc=()=>Cc.map(e=>{const t=Nc.find(n=>n.id===e.userId),i=zc.filter(n=>n.postId===e.id);return{...e,user:t,comments:i}}),jc=()=>j.jsxs("section",{className:"App",children:[j.jsx("h1",{className:"App__title",children:"Static list of posts"}),j.jsx(Rc,{posts:Dc()})]});em(document.getElementById("root")).render(j.jsx(jc,{}));
